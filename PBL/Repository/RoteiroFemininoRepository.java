...
public class RoteiroFemininoRepository extends RoteiroRepository {
    ...
    private Capitulo carregarCapitulo2() {
        // 1. Instancie as falas e cenas do novo episódio
        List<Fala> falasCena1Cap2 = new ArrayList<>();
        falasCena1Cap2.add(new Narrativa(201, "Bem-vindos ao segundo capítulo!", 202));

        // Adicione os diálogos e escolhas da cena...

        Cena cena1 = new Cena(1, "restaurante_vip", "trilha_cap2.mp3", falasCena1Cap2);

        List<Cena> cenasCap2 = new ArrayList<>();
        cenasCap2.add(cena1);

        // 2. Crie o objeto do Capítulo com o ID seguinte (ID = 2)
        Capitulo capitulo2 = new Capitulo(2, "A Segunda Chance", 201, 210, cenasCap2);

        // 3. Registe as falas e o capítulo nos mapas herdados de RoteiroRepository
        for (Fala fala : falasCena1Cap2) {
            bancoDeFalas.put(fala.getIdFala(), fala);
        }
