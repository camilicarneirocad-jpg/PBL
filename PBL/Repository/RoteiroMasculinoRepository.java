...
public class RoteiroMasculinoRepository extends RoteiroRepository {
    ...
    public RoteiroMasculinoRepository(Protagonista prota) {
        this.prota = prota;
        carregarCapitulo1();
        carregarCapitulo2();
        carregarCapitulo3();
    ...
    private void carregarCapitulo1() {
        ...
        falasCena2.add(new Fala(1, "Atenção, audiência! O nosso restaurante está oficialmente de portas abertas. As nossas quatro solteiras já estão em seus lugares no painel, e agora chegou a hora da verdade para o nosso convidado. Bem-vindos à nossa primeira dinâmica da temporada: A Degustação às Cegas!", "Apresentador", null, true, 2));
        ...
        List<Opcoes> opcoesD1 = List.of(
            ...
            new Opcoes(5, "Ah, qualquer lugar serve. Eu sou uma pessoa fácil de lidar, deixo a garota escolher o que ela quiser.", "Falta de atitude!", Map.of(angela, -2), 1, 2, true)
        );
        ...
        List<Opcoes> opcoesD3 = List.of(
            new Opcoes(1, "Procuro alguém ambiciosa, que tenha uma vida badalada...", "Dupla de poder!", Map.of(monica, 5), 1, 0, false),
            ...
            new Opcoes(4, "Quero uma companheira que me desafie...", "Aventura!", Map.of(angela, 5), 1, 0, false),
            new Opcoes(5, "Não sei direito ainda...", "Desculpa fraca!", Map.of(angela, -2), 1, 2, true)
        );
        falasCena2.add(new Dialogo(5, "Para fechar, a 'Sobremesa'! O que você realmente busca em uma parceira?", "Apresentador", null, false, opcoesD3, 6));
    ...
    private void carregarCapitulo2() {
        ...
        List<Fala> falasCena1 = new ArrayList<>();
        falasCena1.add(new Fala(1, "O jogo esquentou, Brasil! O palco ficou pequeno demais para as emoções de hoje, então decidimos mandar o nosso solteiro direto para a ação. Começa agora a nossa rodada de encontros individuais!", "Apresentador", null, true, 2));
    ...
    private void carregarCapitulo5() {
        ...
        List<Fala> falasCena1 = new ArrayList<>();
        falasCena1.add(new Fala(1, "Boa noite, Brasil! Hoje o " + prota.getNome() + " vai direto para a cobertura em um encontro com a glamourosa Mônica!", "Apresentador", null, true, 2));
        falasCena1.add(new Fala(2, "Um ambiente exclusivo e drinks assinados. A Mônica é exigente e busca excelência. Preparado?", "Apresentador", null, true, 3));
        ...
        List<Opcoes> opcoesD3 = List.of(
            ...
            new Opcoes(3, "Sou bem desencanado com detalhes.", "Desencanado", Map.of(monica, -1), 1, 0, false),
        ...
        List<Opcoes> opcoesD4 = List.of(
            ...
            new Opcoes(2, "Gosto de estar bem vestido sem exageros.", "Básico", Map.of(monica, 1), 1, 0, false),
        ...
        List<Opcoes> opcoesD5 = List.of(
            ...
            new Opcoes(3, "Sou mais caseiro, um evento por mês basta.", "Caseiro", Map.of(monica, -1), 1, 0, false),
            new Opcoes(4, "Já estou louco para ir para casa descansar.", "Cansado", Map.of(monica, -3), 1, 4, true)
        );
   ...
   private void carregarCapitulo6() {
        ...
        List<Fala> falasCena1 = new ArrayList<>();
        falasCena1.add(new Fala(1, "E as câmeras não param! Solteiro convocado para missões especiais nos bastidores.", "Apresentador", null, true, 2));
        ...
        List<Opcoes> opcoesD4 = List.of(
            ...
            new Opcoes(4, "A Mônica e o protagonista...", "", Map.of(monicaC6, 3), 1, 0, false),
    ...
    private void carregarCapitulo7() {
        ...
        falasCena1Facil.add(new Fala(1, "Olá! Sejam bem-vindos a mais um episódio de reserva para dois. Hoje o nosso programa está mais que especial porque serão vocês, isso mesmo, vocês aí da plateia, que irão ditar o rumo do nosso participante. Apresento a vocês o nosso quadro Gabarito do amor! Roda a vinheta!", "Apresentador", null, true, 2));
        falasCena1Facil.add(new Fala(2, "Nesse quadro o " + prota.getNome() + " irá abrir o seu coração e responder perguntas pessoais feitas pelos nossos telespectadores. Será que ele será capaz de passar na prova mais difícil da sua vida: o vestibular do amor?", "Apresentador", null, true, 3));
        ...
        List<Opcoes> opcoesMarciaFacil = List.of(
            ...
            new Opcoes(3, "Fico irritado com o silêncio e começo a reclamar que ela está tornando o encontro estranho e que deveria se esforçar mais para conversar.", "Impaciente", Map.of(marciaC7, 0), 1, 0, false)
        );
        ...
        List<Opcoes> opcoesP5Facil = List.of(
            new Opcoes(1, "Sou totalmente sincero, assumo meus erros do passado de forma madura e mostro que mudei.", "Maduro", Map.of(angelaC7, 5, monicaC7, 5, marciaC7, 5, gabrielaC7, 5), 1, 0, false),
        ...
        falasCena1Dificil.add(new Fala(2, "Nesse quadro o " + prota.getNome() + " irá abrir o seu coração e responder perguntas pessoais feitas pelos nossos telespectadores. Será que ele será capaz de passar na prova mais difícil da sua vida: o vestibular do amor?", "Apresentador", null, true, 3));
        ...
        List<Opcoes> opcoesMarciaDificil = List.of(
            new Opcoes(1, "Percebo o desconforto e pergunto tranquilamente se ela prefere procurar um lugar mais reservado, sem pressioná-la a conversar.", "Compreensivo", Map.of(marciaC7, 20), 1, 0, false),
            new Opcoes(2, "Tento fazer com que ela se solte à força, fazendo várias perguntas e dizendo que ela precisa parar de ser tão tímida.", "Invasivo", Map.of(marciaC7, -20), 1, 2, true),
            new Opcoes(3, "Fico irritado com o silêncio e começo a reclamar que ela está tornando o encontro estranho e que deveria se esforçar mais para conversar.", "Impaciente", Map.of(marciaC7, -20), 1, 2, true)
        );
        ...
        falasCena2Angela.add(new Fala(1, "Ufa, o dia foi extremamente desgastante. Se as coisas continuarem dessa forma, posso acabar cometendo algum erro que leve o público me odiar.", prota.getNome(), null, true, 2));
        ...
        falasCena2Angela.add(new Fala(5, "Não sei... Não tenho confiança. Estou me sentindo pressionado e acho que não vou ser capaz de ser um bom candidato.", prota.getNome(), null, true, 6));
        ...
        falasCena2Monica.add(new Fala(1, "Ufa, o dia foi extremamente desgastante. Se as coisas continuarem dessa forma, posso acabar cometendo algum erro que leve o público me odiar.", prota.getNome(), null, true, 2));
        falasCena2Monica.add(new Fala(2, "[Mônica entra, pega uma bebida e percebe a expressão dele.]\n\nVocê está com uma cara péssima.", "Mônica", null, true, 3));
        falasCena2Monica.add(new Fala(3, "Obrigado... eu acho.", prota.getNome(), null, true, 4));
        falasCena2Monica.add(new Fala(4, "Não foi um elogio. Mas também não foi uma crítica. Foi uma observação.", "Mônica", null, true, 5));
        falasCena2Monica.add(new Fala(5, "Estou começando a achar que não sirvo para isso. Quanto mais eu tento agradar todo mundo, mais parece que faço tudo errado.", prota.getNome(), null, true, 6));
        falasCena2Monica.add(new Fala(6, "Você percebeu agora?", "Mônica", null, true, 7));
        falasCena2Monica.add(new Fala(7, "Nossa, obrigado pelo apoio.", prota.getNome(), null, true, 8));
        falasCena2Monica.add(new Fala(8, "Estou tentando ajudar. Só que você está fazendo uma coisa muito perigosa.", "Mônica", null, true, 9));
        falasCena2Monica.add(new Fala(9, "O quê?", prota.getNome(), null, true, 10));
        falasCena2Monica.add(new Fala(10, "Você está tentando descobrir o que todo mundo quer que você seja.", "Mônica", null, true, 11));
        falasCena2Monica.add(new Fala(11, "E qual é o problema disso?", prota.getNome(), null, true, 12));
        falasCena2Monica.add(new Fala(12, "Que, no fim, você pode acabar não sabendo mais quem você é.", "Mônica", null, true, 13));
        falasCena2Monica.add(new Fala(13, "[Ela tira uma pequena caixa da bolsa.]", "Narrador", null, true, 14));
        falasCena2Monica.add(new Fala(14, "O que é isso?", prota.getNome(), null, true, 15));
        falasCena2Monica.add(new Fala(15, "Abre.", "Mônica", null, true, 16));
        falasCena2Monica.add(new Fala(16, "[Ele abre a caixa e encontra uma caneta elegante.]", "Narrador", null, true, 17));
        falasCena2Monica.add(new Fala(17, "Ganhei quando comecei a trabalhar na Itália. Sempre usei para desenhar minhas primeiras ideias.", "Mônica", null, true, 18));
        falasCena2Monica.add(new Fala(18, "Você está me dando isso?", prota.getNome(), null, true, 19));
        falasCena2Monica.add(new Fala(19, "Estou. Talvez você precise começar a escrever a sua própria história em vez de tentar seguir o roteiro que esperam de você.", "Mônica", null, true, 20));
        falasCena2Monica.add(new Fala(20, "Isso foi... surpreendentemente profundo.", prota.getNome(), null, true, 21));
        falasCena2Monica.add(new Fala(21, "Não se acostuma.", "Mônica", null, true, -1));

        Cena cena2Monica = new Cena(4, "cafe_monica", "trilha_emocionante.mp3", falasCena2Monica);
        cena2Monica.setIdPrimeiraFala(1);
        cena2Monica.setIdUltimaaFala(21);
        cenasCap7.add(cena2Monica);

        List<Fala> falasCena2Marcia = new ArrayList<>();
        falasCena2Marcia.add(new Fala(1, "[Márcia aparece na entrada. Ela hesita por alguns segundos antes de se aproximar.]\n\nPosso... sentar aqui?", "Márcia", null, true, 2));
        falasCena2Marcia.add(new Fala(2, "Claro.", prota.getNome(), null, true, 3));
        falasCena2Marcia.add(new Fala(3, "[Ela se senta, mantendo certa distância. Os dois ficam alguns segundos em silêncio.]\n\nÚltima vez. Você não precisa falar nada.", prota.getNome(), null, true, 4));
        falasCena2Marcia.add(new Fala(4, "Eu sei.", "Márcia", null, true, 5));
        falasCena2Marcia.add(new Fala(5, "[Mais alguns segundos de silêncio.]\n\nEu acho que vou desistir.", prota.getNome(), null, true, 6));
        falasCena2Marcia.add(new Fala(6, "Por quê?", "Márcia", null, true, 7));
        falasCena2Marcia.add(new Fala(7, "Porque estou cansado de sentir que estou sendo avaliado o tempo inteiro. Parece que qualquer coisa que eu fizer pode ser o motivo para alguém não gostar de mim.", prota.getNome(), null, true, 8));
        falasCena2Marcia.add(new Fala(8, "Eu conheço essa sensação.", "Márcia", null, true, 9));
        falasCena2Marcia.add(new Fala(9, "Conhece?", prota.getNome(), null, true, 10));
        falasCena2Marcia.add(new Fala(10, "Sentir que todo mundo está esperando você errar.", "Márcia", null, true, 11));
        falasCena2Marcia.add(new Fala(11, "[Ela tira um pequeno marcador metálico de dentro da bolsa.]\n\nIsso é meu.", "Márcia", null, true, 12));
        falasCena2Marcia.add(new Fala(12, "Um marcador?", prota.getNome(), null, true, 13));
        falasCena2Marcia.add(new Fala(13, "Eu uso quando estou estudando. Tem uma frase atrás.", "Márcia", null, true, 14));
        falasCena2Marcia.add(new Fala(14, "[Ele vira o marcador].\n\n\"Um erro não invalida toda a equação.\"", prota.getNome(), null, true, 15));
        falasCena2Marcia.add(new Fala(15, "Eu sei que parece bobo.", "Márcia", null, true, 16));
        falasCena2Marcia.add(new Fala(16, "Não parece.", prota.getNome(), null, true, 17));
        falasCena2Marcia.add(new Fala(17, "Então fica com ele.", "Márcia", null, true, 18));
        falasCena2Marcia.add(new Fala(18, "Tem certeza?", prota.getNome(), null, true, 19));
        falasCena2Marcia.add(new Fala(19, "Tenho.", "Márcia", null, true, 20));
        falasCena2Marcia.add(new Fala(20, "[Ela desvia o olhar, um pouco envergonhada.]\n\nVocê vai precisar mais do que eu hoje.", "Márcia", null, true, -1));

        Cena cena2Marcia = new Cena(5, "cafe_marcia", "trilha_emocionante.mp3", falasCena2Marcia);
        cena2Marcia.setIdPrimeiraFala(1);
        cena2Marcia.setIdUltimaaFala(20);
        cenasCap7.add(cena2Marcia);

        List<Fala> falasCena2Gabriela = new ArrayList<>();
        falasCena2Gabriela.add(new Fala(1, "[Gabriela entra e se senta ao lado dele.]\n\nVocê sabe que é curioso?", "Gabriela", null, true, 2));
        ...
        falasCena2Gabriela.add(new Fala(9, "Então você vai passar o resto da vida tentando ser interessante para pessoas que talvez nem gostem de você.", "Gabriela", null, true, 10));
        falasCena2Gabriela.add(new Fala(10, "[Ela sorri de leve.]\n\nTalvez o problema seja que você está tentando responder ao gabarito certo.", "Gabriela", null, true, 11));
        falasCena2Gabriela.add(new Fala(11, "E não é isso que o programa quer?", prota.getNome(), null, true, 12));
        falasCena2Gabriela.add(new Fala(12, "O programa quer. Eu não.", "Gabriela", null, true, 13));
        falasCena2Gabriela.add(new Fala(13, "[Ela pega um pequeno caderno da bolsa.]", "Narrador", null, true, 14));
        falasCena2Gabriela.add(new Fala(14, "O que é isso?", prota.getNome(), null, true, 15));
        falasCena2Gabriela.add(new Fala(15, "Meu primeiro caderno de histórias.", "Gabriela", null, true, 16));
        falasCena2Gabriela.add(new Fala(16, "Você escreveu isso?", prota.getNome(), null, true, 17));
        falasCena2Gabriela.add(new Fala(17, "Há muito tempo. Eu costumava escrever quando não conseguia explicar o que estava sentindo.", "Gabriela", null, true, 18));
        falasCena2Gabriela.add(new Fala(18, "[Ela entrega o caderno a ele.]", "Narrador", null, true, 19));
        falasCena2Gabriela.add(new Fala(19, "Por que está me dando?", prota.getNome(), null, true, 20));
        falasCena2Gabriela.add(new Fala(20, "Porque talvez você também precise de um lugar onde não existam respostas certas ou erradas.", "Gabriela", null, true, 21));
        falasCena2Gabriela.add(new Fala(21, "Isso é importante para você.", prota.getNome(), null, true, 22));
        falasCena2Gabriela.add(new Fala(22, "É.", "Gabriela", null, true, 23));
        falasCena2Gabriela.add(new Fala(23, "[Ela sorri.]\n\nPor isso estou confiando em você para cuidar dele.", "Gabriela", null, true, -1));

        Cena cena2Gabriela = new Cena(6, "cafe_gabriela", "trilha_emocionante.mp3", falasCena2Gabriela);
        cena2Gabriela.setIdPrimeiraFala(1);
        cena2Gabriela.setIdUltimaaFala(23);
        cenasCap7.add(cena2Gabriela);

        Capitulo capitulo7 = new Capitulo(7, "O Gabarito do Amor", 1, 6, cenasCap7);
